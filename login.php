  ...
  <main class="auth-page">
    <section class="auth-card">
      ...
      <form class="needs-validation" action="aksi.php" method="POST"  novalidate>
        ...
        <div class="mb-3"><label class="form-label" for="LoginUsername">Username</label><input class="form-control" id="loginUsername" type="text" name="nama" required><div class="invalid-feedback">Enter a valid Username.</div></div>
        <div class="mb-3"><div class="d-flex justify-content-between"><label class="form-label" for="loginPassword">Password</label></div><input class="form-control" id="loginPassword" type="password" name="password" nameminlength="6" required><div class="invalid-feedback">Password must be at least 6 characters.</div></div>
        ...
        <button class="btn btn-primary w-100" type="submit" name="proses" value="login"><i class="bi bi-box-arrow-in-right" aria-hidden="true"></i> Sign In</button>
      </form>
    </section>
  </main>
